...
const Book = (props) => {
// call useState to get the 'book' state and a setBook
// function to update 'book'
// When converting, we see that the initial book's value is null,
// so that's what we'll pass to useState
  ...
  if (deleted) {
    return <Redirect to={ { pathname: '/', state: { msg: 'Book deleted!' } } }/>
  }
  return (
    <Layout>
      <h4>{book.title}</h4>
